...
SECRET_KEY = 'django-insecure-b)abpsbwytm9oot-nis(8=rm1v-=js-ef(3+7&nl*c-6$5h71u'
...
# ═══════════════════════════════════════════════════════════════
# For sandbox testing, register at: https://developer.sslcommerz.com/registration/
# For production, register at: https://signup.sslcommerz.com/register
import os
...
# Base URL for constructing callback URLs (no trailing slash)
SSLCOMMERZ_BASE_URL = os.environ.get('SSLCOMMERZ_BASE_URL', 'http://127.0.0.1:8000')
